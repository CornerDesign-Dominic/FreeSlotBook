    ...
    <ScrollView style={uiStyles.screen} contentContainerStyle={contentContainerStyle}>
      ...
      <View style={uiStyles.panel}>
        <Text style={[uiStyles.sectionTitle, { marginBottom: theme.spacing[12] }]}>
          {t('calendarSearch.pendingRequests')}
        </Text>
      ...
      <View style={uiStyles.panel}>
        <Text style={[uiStyles.sectionTitle, { marginBottom: theme.spacing[12] }]}>
          {t('calendarSearch.pendingInvites')}
        </Text>
        {invitesLoading ? (
          <Text style={uiStyles.secondaryText}>{t('common.loading')}</Text>
          ...
          inviteRecords.map(({ invite, calendar }) => {
            ...
            const calendarLabel = calendar?.title || calendar?.publicSlug || invite.calendarId;
            ...
            return (
              <View key={`${invite.calendarId}:${invite.invitedUid}`} style={uiStyles.listItem}>
                ...
                <Text style={[uiStyles.secondaryText, { marginBottom: theme.spacing[12] }]}>{ownerLabel}</Text>
